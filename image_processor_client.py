...
def main_window():
    ...
    ttk.Radiobutton(root, text="Invert", variable=action,
                    value="invert").grid(column=0, row=2, sticky=W)
    ttk.Radiobutton(root, text="Display", variable=action,
                    value="display").grid(column=0, row=3, sticky=W)
    ttk.Radiobutton(root, text="Download", variable=action,
                    value="download").grid(column=0, row=4, sticky=W)
    ...
    upload_btn = ttk.Button(root, text="Upload New")  # command=cancel_button)
